...
public class RestauranteUseCase implements IRestauranteContract {
    ...
    @Override
    public List<Restaurante> findByNomeOrLocalizacaoOrTipoCozinha(IBuscarRestaurante iBuscarRestaurante, Restaurante restaurante) {
        return iBuscarRestaurante.findByNomeOrLocalizacaoOrTipoCozinha(restaurante);
    }
}
