...
public interface IReservaContract extends IRegistrarReservaRule {
    ...
    Reserva validate(IRegistrarReserva iRegistrarReserva, IBuscarRestauranteById restaurantRepository, IManterCliente clienteRepositorio, IAttributeValidatorRule<Reserva> reserva) throws SystemException;
}
